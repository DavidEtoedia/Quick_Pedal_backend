...
let AssignAgentService = class AssignAgentService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const assignAgent = yield this.deliveryRepository.updateDelivery({
                    _id: id
                }, {
                    delivery_agent,
...
AssignAgentService = __decorate([
    (0, tsyringe_1.injectable)(),
    __metadata("design:paramtypes", [utils_1.Http,
        delivery_repository_1.default])
], AssignAgentService);
exports.default = AssignAgentService;
//# sourceMappingURL=assign-agent.service.js.map