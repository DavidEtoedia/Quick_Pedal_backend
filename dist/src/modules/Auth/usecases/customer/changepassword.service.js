...
let ChangepasswordService = class ChangepasswordService {
    constructor(userRepository, otpService, errorService, httpService) {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield this.userRepository.getUser({ _id: id });
                const verifyOTP = yield (0, utils_1.compareHash)(otp, user.otp_reference);
                if (!verifyOTP) {
                ...
                yield this.userRepository.updateUser({
                    _id: id
                }, {
