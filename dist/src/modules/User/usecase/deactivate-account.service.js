...
const account_status_1 = require("../../../common/constants/account_status");
let DeactivateAccountService = class DeactivateAccountService {
    constructor(httpHttp, userRepository) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userData = yield this.userRepository.updateUser({ _id: user.id }, {
                    account_state: account_status_1.AccountStatus.DEACTIVATED
                });
