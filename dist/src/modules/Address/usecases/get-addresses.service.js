...
let GetAddressesService = class GetAddressesService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user } = req.body;
                const userData = yield this.addressRepository.getAddresss({ user: user.id });
