...
let DeleteAddressService = class DeleteAddressService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const userData = yield this.addressRepository.deleteAddress(id);
...
DeleteAddressService = __decorate([
    (0, tsyringe_1.injectable)(),
    __metadata("design:paramtypes", [utils_1.Http,
        address_repository_1.default])
], DeleteAddressService);
exports.default = DeleteAddressService;
//# sourceMappingURL=delete-address.service.js.map